...
const gamblingSites = [
  {
    ...
    logoUrl: '/datdrop-logo.jpg' // Use your uploaded logo or fallback to favicon
  },
  {
    id: 'site_2',
    name: 'CSGOGEM',
  ...
  },
  {
    ...
    logoUrl: 'https://packdraw.com/favicon.ico'
  },
  {
    id: 'site_4',
    name: 'CSGO LUCK',
    ...
    logoUrl: 'https://csgoluck.com/favicon.ico'
  },
  {
    id: 'site_5',
    name: 'Rain.gg',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300">
            Get the best bonuses from top gambling sites using cins code
          </p>
        </div>
